-- Schema as it stood before commit 6c1c682 (store logins / order tracking).
-- The production database matched this exactly on 2026-09-25 (catalog diff),
-- so the migration test starts from here. Test fixture only — never run it.
