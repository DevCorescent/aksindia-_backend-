...
export const productsService = {
  async list(role: UserRole, storeId?: string): Promise<Product[]> {
    ...
    const row = await queryOne(
      `INSERT INTO products
        (store_id, name, description, price, mrp, commission, category_id, category, brand,
         stock, image_color, image_icon, images, status, featured, available_cities, tags,
      ...
      [
        ...
        rest.imageColor, rest.imageIcon, rest.images ?? [],
